      ...
      `}
            ...
            `}
                ...
                <div className="p-2 border-t border-[var(--color-border-primary)]">
                    <button
                        onClick={() => navigate(`/sites/${siteId}/branches`)}
                        className="flex items-center gap-2 w-full px-2 py-1.5 text-xs text-[var(--color-text-muted)] hover:text-[var(--color-text-primary)] hover:bg-[var(--color-bg-hover)] rounded-md transition-colors"
                    >
                        <GitBranch size={14} />
                        <span>Branches</span>
                    </button>
